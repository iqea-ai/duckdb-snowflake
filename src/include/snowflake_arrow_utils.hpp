...
struct SnowflakeArrowStreamFactory {
  ...
  vector<string>
      column_names; // Maps column indices to names for filter building

  SnowflakeArrowStreamFactory(shared_ptr<snowflake::SnowflakeClient> conn,
  ...
  // the source
  void UpdatePushdownParameters(const vector<string> &projection,
