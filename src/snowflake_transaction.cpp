...
SnowflakeTransaction::SnowflakeTransaction(TransactionManager &manager,
                                           ClientContext &context)
    : Transaction(manager, context) {}

SnowflakeTransactionManager::SnowflakeTransactionManager(AttachedDatabase &db)
    : TransactionManager(db) {}

Transaction &
SnowflakeTransactionManager::StartTransaction(ClientContext &context) {
...
ErrorData
SnowflakeTransactionManager::CommitTransaction(ClientContext &context,
...
void SnowflakeTransactionManager::RollbackTransaction(
    Transaction &transaction) {
  // For read-only external database, remove the transaction from our map
  lock_guard<mutex> lock(transaction_lock);
  transactions.erase(transaction);
...
void SnowflakeTransactionManager::Checkpoint(ClientContext &context,
                                             bool force) {
