...
mkdir -p /Users/<username>/.duckdb/extensions/v1.3.2/osx_arm64
mv libadbc_driver_snowflake.so /Users/<username>/.duckdb/extensions/v1.3.2/osx_arm64/
```
...
# Place in DuckDB extensions directory
mkdir -p /Users/<username>/.duckdb/extensions/v1.3.2/osx_amd64
mv libadbc_driver_snowflake.so /Users/<username>/.duckdb/extensions/v1.3.2/osx_amd64/
```
...
# Place in DuckDB extensions directory
mkdir -p /home/<username>/.duckdb/extensions/v1.3.2/linux_amd64
mv libadbc_driver_snowflake.so /home/<username>/.duckdb/extensions/v1.3.2/linux_amd64/
```
...
# Place in DuckDB extensions directory
mkdir C:\Users\%USERNAME%\.duckdb\extensions\v1.3.2\windows_amd64
move libadbc_driver_snowflake.so C:\Users\%USERNAME%\.duckdb\extensions\v1.3.2\windows_amd64\
```
